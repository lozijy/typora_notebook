...
![image-20220521222823585](https://raw.githubusercontent.com/lozijy/github_-/main/image-20220521222823585.png)
...
![image-20220522115504162](https://raw.githubusercontent.com/lozijy/github_-/main/image-20220522115504162.png)
...
![image-20220522115539230](https://raw.githubusercontent.com/lozijy/github_-/main/image-20220522115539230.png)
...
![image-20220522115605397](https://raw.githubusercontent.com/lozijy/github_-/main/image-20220522115605397.png)
...
class Solution {
    public int minimumLines(int[][] stockPrices) {
        ...
        int l=stockPrices[0][0];
        int r=0;
        while(r<=stockPrices[stockPrices.length-1][0]){
            r=l+1;
            int cur=stockPrices[l+1][1]-stockPrices[l][1];
            if((stockPrices[r][1]-stockPrices[l][1])/(r-l)==cur){
                r++;
            }else{
                ans++;
                l=r;
...
![image-20220522115641802](https://raw.githubusercontent.com/lozijy/github_-/main/image-20220522115641802.png)
